      ...
      <div className="header__container">
        ...
        <a className="header__menu_link" href="#">Resources</a> --> */}
            ...
            <div className="header__menu_links">
              <a href="https://x.com/cedranetwork" target="_blank">
                <img src="./images/x.svg" alt="x" />
              </a>
              <a href="https://t.me/cedranetworkchat" target="_blank">
                <img src="./images/tg.svg" alt="tg" />
              </a>
              <a href="https://discord.com/invite/cedranetwork" target="_blank">
